...
public class SpecialEffectsShip : MonoBehaviour
{
    ...
    {
        GetComponent<VariationEffectsShip>().bigFireballSize *= specialStatChanges[0];
        Debug.Log("Bought Special0");
    }
    public void SetSpecial1()
    {
        GetComponent<Stats>().bulletMovementSpeed += specialStatChanges[1];
    ...
    public void SetSpecial2()
    {
        ...
        GetComponent<Stats>().poisonTime += specialStatChanges[2];
    ...
    {
        GetComponent<Stats>().burnTime += specialStatChanges[4];
    ...
    {
        specialInfoTexts[0] = "Fireball Size: " + specialStatChanges[0] * 100 + "%";
        specialInfoTexts[1] = "Bullet Speed: +" + specialStatChanges[1];
        specialInfoTexts[2] = "Effect Duration: +" + specialStatChanges[2] + "s";
        specialInfoTexts[3] = "Attack Speed: " + specialStatChanges[3] + "s";
        specialInfoTexts[4] = "Burn Duration: +" + specialStatChanges[4] + "s";
